...
myfont = matplotlib.font_manager.FontProperties(fname="/home/python/Desktop/ShuJu_FenXi/中文字体/NotoSansCJK-Black.ttc")  # 设定字体
...
plt.title('两小时内的气温变化情况',fontproperties=myfont)  # fontproperties没有提示的
